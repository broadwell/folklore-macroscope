...
$centroidsFile = fopen("data/RegionCenters.txt", "r");
...
$wordsFile = fopen("data/geolda_tag_freqs.txt", "r");
...
$topicsToRegionsFile = fopen("data/TopicsToRegions.txt", "r");
...
$wordsToTopicsFile = fopen("data/WordsToTopics.txt", "r");
...
$geoJSON .= '], "properties": {"itemName":"GeoLDA"}';
