...
$itemType = "index";
//$itemName = "ETK_waterspirits";
//$itemVal = "ETK_waterspirits";
...
if ($itemType == "index") {
  ...
  $PlacesQuery = "SELECT * FROM story_to_place_mentioned, story_to_etk_index_merged, geo_places WHERE story_to_etk_index_merged.etk_index_id=" . $ETKIndexID . " AND story_to_place_mentioned.story_id=story_to_etk_index_merged.story_id AND story_to_place_mentioned.place_id=geo_places.place_id";
